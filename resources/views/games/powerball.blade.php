            ...
            <div class="col-md-8 col-md-offset-2 new-game" id="show">
                    ...
                    <div class="col-md-7">
                        <div class="text-game">
                            <ul>
                                <li>1.	选择您要投注的彩票类型</li>
                                <li>2.	选号投注</li>
                                <li>3.	我们美国公司工作人员会到彩票官方指定点，帮您代购</li>
                                <li>4.	您拥有100%彩票所有权，中奖后彩金100%归您所有，我们不收取任何彩金的佣金</li>
                            </ul>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-7">
                        <div class="text-game">
                            <ul>
                                <li>1.	您的彩票被扫描到您个人帐户，您可在账户中看见真实票根</li>
                                <li>2.	网上付费加密加锁系统，保证了网上支付的安全性</li>
                                <li>3.	您的彩票安全妥善的保存在美国银行的保险箱里，直到开奖结束</li>
                            </ul>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-7">
                        <div class="text-game">
                            <ul>
                                <li>1.	足不出户，便可以买到美国官方彩票</li>
                                <li>2.	自动兑奖系统，及时通知您中奖</li>
                                <li>3.	奖金即时兑现，存入您的账户</li>
                            </ul>
                        </div>
                    </div>
                </div>
