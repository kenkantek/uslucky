...
.list{
  ...
  .list li{
        ...
        <p>Your order #{{ $order->id }} was @if($order->status->status == 'purchased') <span style="color: green; font-weight: bold;">purchased</span> @elseif($order->status->status == 'canceled') <span style="color: red; font-weight: bold;">canceled</span> @else change to <span style="color: red; font-weight: bold;">Pending Purchase</span> @endif!</p>
